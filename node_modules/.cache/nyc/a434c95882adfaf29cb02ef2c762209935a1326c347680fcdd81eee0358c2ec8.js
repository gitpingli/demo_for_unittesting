 ...
 */class DashboardController extends Controller{/**
   ...
   */async usageOfServices(){cov_13d8rqqpqp.f[0]++;const{ctx}=(cov_13d8rqqpqp.s[1]++,this);const res=(cov_13d8rqqpqp.s[2]++,await ctx.service.gateway.dashboard.usageOfServices(ctx.query));cov_13d8rqqpqp.s[3]++;ctx.body=res;}/**
   ...
   * @Response 200
   * @Response 500 error Unknown internal server error
   */async usageOfOneApplication(){cov_13d8rqqpqp.f[1]++;const{ctx}=(cov_13d8rqqpqp.s[4]++,this);const{id}=(cov_13d8rqqpqp.s[5]++,ctx.params);const res=(cov_13d8rqqpqp.s[6]++,await ctx.service.gateway.dashboard.usageOfOneApplication(id,ctx.query));cov_13d8rqqpqp.s[7]++;ctx.body=res;}/**
   ...
   * @Response 200
   * @Response 500 error Unknown internal server error
   */async usageOfTops(){cov_13d8rqqpqp.f[2]++;const{ctx}=(cov_13d8rqqpqp.s[8]++,this);const res=(cov_13d8rqqpqp.s[9]++,await ctx.service.gateway.dashboard.usageOfTops(ctx.query));cov_13d8rqqpqp.s[10]++;ctx.body=res;}/**
   ...
   * @Response 200
   * @Response 500 error Unknown internal server error
   */async usageBreakdown(){cov_13d8rqqpqp.f[3]++;const{ctx}=(cov_13d8rqqpqp.s[11]++,this);const res=(cov_13d8rqqpqp.s[12]++,await ctx.service.gateway.dashboard.usageBreakdown(ctx.query));cov_13d8rqqpqp.s[13]++;ctx.body=res;}}cov_13d8rqqpqp.s[14]++;module.exports=DashboardController;